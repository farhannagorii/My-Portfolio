    ...
    <section className="w-full bg-[#1B4D3E]    pt-31 pb-35   md:px-20">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative flex justify-center">
          ...
          <div className="w-72 h-72 bg-[#F7A400] rounded-full absolute top-6 left-6"></div>
          ...
          {/* Skills Badges */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-white py-3 px-4 rounded-full shadow-md flex gap-2 flex-wrap text-xs z-20">
